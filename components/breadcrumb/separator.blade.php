<span role="presentation" aria-hidden="true" {{ $attributes->mergeTailwind(['class' => 'lux-breadcrumb-separator flex h-5 w-5 items-center justify-center text-muted-foreground']) }}>
    @if(!((string) $slot))
