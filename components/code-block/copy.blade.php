...
:component="$lux->componentPath('button')" variant="ghost" size="icon" x-on:click="navigator.clipboard.writeText({!! json_encode($text) !!}); copied = true; setTimeout(() => copied = false, 2000);"
>
