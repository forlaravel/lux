        ...
        return {
            ...
            "x-data"() {
                return {
                    ...
                    get items() {
                        return this.$refs.content ? [...this.$refs.content.querySelectorAll('[role=option]')] : []
                    },
                    get activeItems() {
                    ...
                    updateLabelValueCache(items) {
                       items.forEach(item => {
                            let index = this.labelValueCache.findIndex(i => i.value === item.value)
                            if (index > -1) {
                                 this.labelValueCache[index] = item
                            } else {
                    ...
                    isValid(value) {
                        if (this.labelValueCache.find(item => item.value === value)) return true;
