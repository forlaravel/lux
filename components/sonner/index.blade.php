...
<div
    ...
    x-sonner
    x-data
    :class="'lux-sonner-position-' + position + (richColors ? ' lux-sonner-rich' : '') + (stacked ? ' lux-sonner-stacked' : '')"
    :style="Object.assign({ '--sonner-offset': typeof offset === 'number' ? offset + 'px' : offset, '--sonner-gap': gap + 'px' }, containerStyle())"
