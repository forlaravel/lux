...
<div
    ...
    :aria-describedby="$id('drawer-description')"
    x-effect="
        if (!dragging) {
...
>
    ...
    @if($showCloseButton)
        <button class="lux-drawer-close-button" x-on:click="close()" type="button" aria-label="Close">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-4" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
