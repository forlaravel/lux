...
<x-alert>
    ...
    <div>
        ...
        <x-alert.description>The is the default variant.</x-alert.description>
    </div>
</x-alert>
<br>
<x-alert variant="destructive">
    ...
    <div>
        <x-alert.title>Heads up!</x-alert.title>
        <x-alert.description>You can add components to your app using the CLI.</x-alert.description>
    </div>
</x-alert>
```
